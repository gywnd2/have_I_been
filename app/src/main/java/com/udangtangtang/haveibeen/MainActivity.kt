...
//                infoWindowData = dbHelper!!.getInfoWindowData(selectedLatLng)
                ...
                if (infowindowBinding.infoWindowLocationTitle==null){ getString(R.string.record_detail_no_locName)} else pictureDB.pictureDao().getLocationName()
                infowindowBinding.infoWindowLocationTitle
